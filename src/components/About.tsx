          ...
          <div className="bg-card rounded-3xl pt-8 md:pt-12 px-6 md:px-12 pb-6 md:pb-8 transition-smooth md:hover:scale-105 cursor-pointer overflow-hidden max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-12 mb-8">
              ...
              <div className="space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed text-center md:text-left md:flex-1 mt-6 md:mt-0">
                ...
                <p className="text-justify">I started in strategy consulting at Detecon (Deutsche Telekom Group), with assignments in Seattle and Silicon Valley, then led digital transformation at FTI Group across 20+ countries. In 2018 I moved into venture building at AI travel-tech startup Fineway (Series A, EUR 25m raised), scaling from 15 to ~100 people. In 2021 I co-founded Laya Technologies, a B2B SaaS for premium hotel brands including Marriott, raised a EUR 4m Seed and led it to a strategic exit within 18 months. Since the exit, I work independent: fractional executive mandates as well as board and founder advisory across deep tech and AI.</p>
              </div>
            </div>
